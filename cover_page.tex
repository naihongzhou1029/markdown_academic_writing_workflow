...
\newcommand{\Title}{利用生成式人工智慧技術最大化論文寫作框架價值的策略}
\newcommand{\EnglishTitle}{Strategies to Maximize Thesis Writing Workflow Using Generative AI Framework}
\newcommand{\Author}{姓名}
\newcommand{\Advisor}{指導教授 博士}
