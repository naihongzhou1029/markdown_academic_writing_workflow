...
\newcommand{\Title}{利用生成式人工智慧技術最大化遊戲規格書價值的策略}
\newcommand{\EnglishTitle}{Strategies to maximize the value of game specifications using generative artificial intelligence techniques}
...
\vspace{20mm}
\begin{center}
  {\CJKfamily{song}\fontsize{16pt}{24pt}\selectfont \Title}\\[4mm]
  {\fontsize{14pt}{20pt}\selectfont \EnglishTitle}
\end{center}
